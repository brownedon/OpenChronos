...
CC_INCLUDE = -I$(PROJ_DIR)/ -I$(PROJ_DIR)/include/ -I$(PROJ_DIR)/gcc/ -I$(PROJ_DIR)/driver/ -I$(PROJ_DIR)/logic/ -I$(PROJ_DIR)/bluerobin/ -I$(PROJ_DIR)/simpliciti/ -I$(PROJ_DIR)/simpliciti/Components/nwk -I$(PROJ_DIR)/swap/ -I$(PROJ_DIR)/swap/bsp -I$(PROJ_DIR)/swap/bsp/drivers -I$(PROJ_DIR)/swap/bsp/boards/CC430EM -I$(PROJ_DIR)/swap/mrfi/
